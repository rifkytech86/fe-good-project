        ...
        return (
            <React.Fragment>
                ...
                <ul className="metismenu list-unstyled" id="side-menu">
                    ...
                    <li className="menu-title">Sales Order</li>

                    <li>
                        <Link to="calendar" className=" waves-effect">
                            <i className="bx bx-cut"></i>
                            <span>{this.props.t('Cuting') }</span>
                        </Link>
                    </li>
                    ...
                    {/*        <span>{this.props.t('Sales Order')}</span>*/}
                    {/*    </Link>*/}
                    {/*    <ul className="sub-menu">*/}
                    {/*        <li><Link to="pages-login">{this.props.t('Cuting')}</Link></li>*/}
                    {/*        <li><Link to="pages-register">{this.props.t('Sablon')}</Link></li>*/}
                    {/*        <li><Link to="pages-forget-pwd">{this.props.t('Jahit')}</Link></li>*/}
                    {/*        <li><Link to="auth-lock-screen">{this.props.t('QC')}</Link></li>*/}
                    {/*    </ul>*/}
                    {/*</li>*/}
                    {/*<li>*/}
                    {/*    <Link to="/#" className="has-arrow waves-effect">*/}
                    ...
                    <li>
                        <Link to="data-employee" className=" waves-effect">
                            <i className="bx bx-user"></i>
                            <span>{this.props.t('Data Pegawai') }</span>
                        </Link>
                    </li>

                    <li>
                        <Link to="data-supplier" className=" waves-effect">
                            <i className="bx bxs-factory"></i>
                            <span>{this.props.t('Data Supplier') }</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="data-users" className=" waves-effect">
                            <i className="bx bx-user-circle"></i>
                            <span>{this.props.t('Data User') }</span>
                        </Link>
                    </li>
