...
class Index extends Component {
    ...
    handleEdit(e)  {
        this.props.history.push(
            ...
            {
                attribute: {
                    breadcrumb: "Form Edit User",
                    desc: "Edit Data untuk user "
                },
            ...
            <React.Fragment>
                <div className="page-content">
                    <div className="container-fluid">
                        <Breadcrumbs title="Tables" breadcrumbItem="Data Pegawai" />
                        ...
                        <Row>
                            <Col className="col-12">
                                <Card>
                                    <CardBody>
                                        <CardTitle>List Data Pegawai</CardTitle>
                                        <CardSubtitle className="mb-3">
                                            List data pegawai bisa masuk ke dalam admin panel
                                        </CardSubtitle>
